...
python -m python_scripts.mass_map.mass_map "meta_lensing_output/calibrate/${CLN}_noshear_dered_dezp_zphot_gals_meta_cal.csv" "100" "1.8" "meta_lensing_output/mass_map/" "20" "decam" "0" "${CLN}" "schirmer"
