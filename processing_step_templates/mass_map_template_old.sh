...
#TODO update the script folder
cpu_num="96"
script_folder="cluster_dir/python_scripts/mass_map"
output_folder="mass_map_output"
...
cleaned_catalog_csv="${output_folder}/${patches_tag}_${tag}_dered_dezp_bpz_merge_cut.csv"
...
cluster_mass_map_peak_pixel_filename="${output_folder}/cluster_name_mass_map_peak_pixel.csv"
...
echo ""
echo "Making cut on the catalog..."

python ${script_folder}/cut.py ${input_catalog_csv} ${cleaned_catalog_csv}
...
python ${shear_calibration_folder}/gen_hsc_calibrations.py ${cleaned_catalog_csv} ${shear_calibration_output} 


# Merge the shear calib result with the original catalog.
python ${script_folder}/horizontal_merge_table.py ${cleaned_catalog_csv} ${shear_calibration_output} ${merged_catalog_csv}
...
do
    ...
    echo "-----------------------------"
    echo "--> Running Rs=${Rs}..."
    python -W ignore ${script_folder}/schirmer_snr_weight.py ${merged_catalog_g_csv} ${Rs} ${cpu_num} ${combine_patch_color_folder} ${SNR_threshold} 
...
python ${script_folder}/Rs_vs_E_SNR_max.py ${output_folder}/cluster_name_M_ap_SNR_b100 cluster_name ${cluster_mass_map_peak_pixel_filename}
...
Rs=$(python ${script_folder}/get_Rs.py ${cluster_mass_map_peak_pixel_filename})
echo ""
...
if [ -f ${Xray_image} ]; then
    ...
    python ${script_folder}/overplot_contour2.py ${optical_image_R1} ${optical_image_G1} ${optical_image_B1} ${massmap_image_wcs} ${Xray_image} cluster_name ${patch_tag1}
    python ${script_folder}/overplot_contour2_inv.py ${optical_image_G1} ${optical_image_G1} ${optical_image_G1} ${massmap_image_wcs} ${Xray_image} cluster_name ${patch_tag1}

    python ${script_folder}/overplot_contour2.py ${optical_image_R2} ${optical_image_G2} ${optical_image_B2} ${massmap_image_wcs} ${Xray_image} cluster_name ${patch_tag2}
    python ${script_folder}/overplot_contour2_inv.py ${optical_image_G2} ${optical_image_G2} ${optical_image_G2} ${massmap_image_wcs} ${Xray_image} cluster_name ${patch_tag2}

else
    python ${script_folder}/overplot_contour2.py ${optical_image_R1} ${optical_image_G1} ${optical_image_B1} ${massmap_image_wcs} cluster_name ${patch_tag1}
    python ${script_folder}/overplot_contour2_inv.py ${optical_image_G1} ${optical_image_G1} ${optical_image_G1} ${massmap_image_wcs} cluster_name ${patch_tag1}

    python ${script_folder}/overplot_contour2.py ${optical_image_R2} ${optical_image_G2} ${optical_image_B2} ${massmap_image_wcs} cluster_name ${patch_tag2}
    python ${script_folder}/overplot_contour2_inv.py ${optical_image_G2} ${optical_image_G2} ${optical_image_G2} ${massmap_image_wcs} cluster_name ${patch_tag2}
...
echo "Montage..."
python ${script_folder}/montage.py mass_map_output/cluster_name_M_ap_SNR_b100 ${SNR_threshold}
