...
from lsst.pipe.tasks.mergeDetections import MergeDetectionsConfig, MergeDetectionsTask  # noqa: F401
from lsst.pipe.tasks.mergeMeasurements import MergeMeasurementsConfig, MergeMeasurementsTask  # noqa: F401
from lsst.pipe.tasks.multiBandUtils import CullPeaksConfig  # noqa: F401
from lsst.pipe.tasks.deblendCoaddSourcesPipeline import DeblendCoaddSourcesSingleConfig  # noqa: F401
from lsst.pipe.tasks.deblendCoaddSourcesPipeline import DeblendCoaddSourcesSingleTask  # noqa: F401
from lsst.pipe.tasks.deblendCoaddSourcesPipeline import DeblendCoaddSourcesMultiConfig  # noqa: F401
from lsst.pipe.tasks.deblendCoaddSourcesPipeline import DeblendCoaddSourcesMultiTask  # noqa: F401
...
class MeasureMergedCoaddSourcesTask(PipelineTask):
    ...
    **kwargs
    ...
    def runQuantum(self, butlerQC, inputRefs, outputRefs):
        ...
        # HARD CODED BUGFIX HERE
        # fixed in later versions of LSSTPipe
        if self.config.doMatchSources:
