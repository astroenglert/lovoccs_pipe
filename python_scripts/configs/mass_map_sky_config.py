...
# == configuration for mass_map_sky.py == #

# coordinates for a custom center, defaults to finding the center in Simbad via the cluster-name
# otherwise expects a SkyCoord specifying the Ra/Dec
custom_center = None # SkyCoord(ra=,dec=,unit='degree')
