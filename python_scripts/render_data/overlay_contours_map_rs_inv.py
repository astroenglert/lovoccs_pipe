...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 6:
        ...
        rs_image_filepath = sys.argv[2]
        peak_table_filepath = sys.argv[3]
        map_output_directory = sys.argv[4]
    ...
    rs_hdul = fits.open(rs_image_filepath)
    ...
    rs_data = fits.getdata(rs_image_filepath)
    rs_wcs = WCS(rs_hdul[0].header)
